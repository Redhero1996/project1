...
<body>
    <div class="container-fluid login">
        ...
        <!-- Email -->
        {!! Form::email('email', null, ['class' => 'form-control email', 'id' => 'defaultLoginFormEmail', 'placeholder'
        => 'E-mail']) !!}
        @if ($errors->has('email'))
        ...
        @endif
        <!-- Password -->
        {!! Form::password('password', ['class' => 'form-control mt-4 password', 'id' => 'defaultLoginFormPassword',
        ...
        <div class="d-flex justify-content-around mt-4">
            <div>
                ...
                <div class="custom-control custom-checkbox">
                    {!! Form::checkbox('remember', null, old('remember') ? true : '', ['class' =>
                    'custom-control-input', 'id' => 'defaultLoginFormRemember']) !!}
                    {!! Form::label('defaultLoginFormRemember', trans('translate.remember'), ['class' =>
